...
public class MaterialButton extends Button implements View.OnTouchListener {
	...
	private void init() {
		...
		if (resources == null)
			return;
		mButtonColor = resources.getColor(R.color.yellowcolor);
		mShadowColor = resources
				.getColor(R.color.yellowcolor);
		mShadowHeight = resources
				.getDimensionPixelSize(R.dimen.materialbutton_default_shadow_height);
		mCornerRadius = resources
				.getDimensionPixelSize(R.dimen.materialbutton_default_conner_radius);
	}
	...
	public void setMaterialButtonPadding(int left, int top, int right,
			int bottom) {
		mPaddingLeft = left;
		mPaddingRight = right;
		mPaddingTop = top;
