package italo.com.app.italomovil.widgets.refresh_layout;
...
public class RefreshLayout extends ViewGroup {
	...
	public RefreshLayout(Context context, AttributeSet attrs) {
		...
		final int type = a.getInteger(R.styleable.RefreshLayout_type,
				STYLE_RING);
		final int colorsId = a.getResourceId(
				R.styleable.RefreshLayout_colors, R.array.google_colors);
		a.recycle();
	...
	public void setDurations(int durationToStartPosition,
