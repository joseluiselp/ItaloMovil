...
public class MaterialRoundedImageView extends ImageView {
    ...
    public static final String TAG = "MaterialRoundedImageView";
    ...
    public MaterialRoundedImageView(Context context) {
        super(context);
    }

    public MaterialRoundedImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MaterialRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
